    ...
    (c = ga.support = {}),
      ...
      (d = ga.selectors = {
        ...
        preFilter: {
          ATTR: function (a) {
            return (
              (a[1] = a[1].replace(ca, da)), (a[3] = (a[3] || a[4] || a[5] || '').replace(ca, da)), '~=' === a[2] && (a[3] = ' ' + a[3] + ' '), a.slice(0, 4)
            );
          },
          CHILD: function (a) {
            return (
        ...
        while (j--)
          (h = Y.exec(b[j]) || []),
            ...
            o &&
              ...
              (m = i[o]) ||
                ((m = i[o] = []), (m.delegateCount = 0), (l.setup && l.setup.call(a, d, p, g) !== !1) || (a.addEventListener && a.addEventListener(o, g, !1))),
  ...
  n.extend({
    ...
    ajax: function (a, b) {
      ...
      (i = n.event && k.global),
        ...
        v.setRequestHeader(
          'Accept',
          k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ('*' !== k.dataTypes[0] ? ', ' + nb + '; q=0.01' : '') : k.accepts['*']
        );
